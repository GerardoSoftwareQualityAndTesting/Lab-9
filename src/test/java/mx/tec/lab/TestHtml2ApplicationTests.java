...
class TestHtml2ApplicationTests {
  ...
  public void setup() {
    System.setProperty(
      ...
      "D:\\gerar\\Documents\\1 Escuela\\6 Semestre Feb-Jun 2021\\4 Pruebas de Software\\Lab 9\\chromedriver.exe"
    );
  ...
  public void givenAClient_whenEnteringLoginCredentials_thenAccountPageIsDisplayed()
    ...
    // When
    driver.get(
      "http://automationpractice.com/index.php?controller=authentication&back=myaccount"
    );

    WebElement emailField = driver.findElement(By.id("email"));
    emailField.sendKeys("gerardo@automation.com");

    WebElement passwordField = driver.findElement(By.id("passwd"));
    passwordField.sendKeys("Gpassword");
  ...
  public void givenAClient_whenSearchingNotExistingProduct_thenNoResultsDisplayed()
    ...
    WebElement alert = driver.findElement(
      By.xpath("//p[@class='alert alert-warning']")
    );
    String alertMessage = alert.getText();

    // Then
    assertEquals(
      "No results were found for your search \"not existing product\"",
      alertMessage
    );
  }
